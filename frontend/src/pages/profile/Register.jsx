        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-50 to-indigo-50 p-12 flex-col justify-center">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Start your educational journey with thousands of learners worldwide.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Learn from expertly curated educational resources
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Engage with a community of passionate learners
                </p>
              </div>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-500">
              Over 50,000+ students trusted us with their learning journey
            </p>
          </div>
        </div>
